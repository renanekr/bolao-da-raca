...
// exports.sendEmailNotification = functions.database.ref('/users/{uid}').onWrite(async (change) => {
exports.sendEmailNotification = functions.database.ref('/users/ixjWWiGbyzXAyTSBzVNDTpE1DOg2').onWrite(async (change) => {
...
//   }
  ...
  const mailOptions = {
    from: '"Bolão da Raça" <falecom@renan.inf.br>',
    to: val.email,
  };
